...
{
	iki_relocate(dp, "xsim.dir/tb_riscv_multicycle_behav/xsim.reloc",  (void **)funcTab, 40);
	iki_vhdl_file_variable_register(dp + 50280);
	iki_vhdl_file_variable_register(dp + 50336);
